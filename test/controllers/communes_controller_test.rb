...
class CommunesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commune" do
    assert_difference('Commune.count') do
      post communes_url, params: { commune: { display_in_index: @commune.display_in_index, name: @commune.name } }
    end
  ...
  test "should update commune" do
    patch commune_url(@commune), params: { commune: { display_in_index: @commune.display_in_index, name: @commune.name } }
