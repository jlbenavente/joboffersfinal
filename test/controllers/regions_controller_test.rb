...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { display_in_index: @region.display_in_index, name: @region.name } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { display_in_index: @region.display_in_index, name: @region.name } }
